<?php
	/*
		Template Name: Experts Create
	*/
	get_header();
	wp_enqueue_script('experts_create', get_template_directory_uri().'/js/experts_create.js');
?>
				...
				<fieldset>
					...
					<div class='form-row' >
						...
						<div class='form-value' >
							<input id='name' type='text' name='Name' value='' placeholder='Фамилия Имя Отчество' autocomplete='off' required />
						</div>
					</div>
					<div class='form-row' >
						<div class='form-name' >
						...
						<div class='form-value' >
							<input type='text' name='CallName' value='' placeholder='Имя Отчество' autocomplete='off' required />
						</div>
					</div>
					<div class='form-row' >
						<div class='form-name' >
					...
					<div class='form-row' >
						<div class='form-name' >
							<label for='Phone'>Сотовый (+7):</label>
						</div>
						<div class='form-value' >
							<input id='phone' type='text' name='Phone' value='' autocomplete='off' pattern='[0-9]{10}' />
						</div>
					</div>
					<div class='form-row' >
						<div class='form-name' >
