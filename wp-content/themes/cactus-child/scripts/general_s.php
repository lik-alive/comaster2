...
function g_lev_j($message, $function, $value = null)
{
	return g_ctj(g_lev($message, $function, $value));
}
...
function g_ler_j($message, $function, $value = null)
{
	return g_ctj(g_ler($message, $function, $value));
}
